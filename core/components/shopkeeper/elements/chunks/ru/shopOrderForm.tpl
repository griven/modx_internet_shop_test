...
<tr>
    ...
    <td>
        <select name="payment" style="width:200px;">
            <option value="При получении" [[!+fi.payment:isSelected=`При получении`]]>При получении</option>
            <option value="robokassa" [[!+fi.payment:isSelected=`robokassa`]]>Электронные деньги</option>
        </select>
    </td>
</tr>
<tr>
